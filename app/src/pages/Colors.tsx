...
export default function Colors() {
  ...
  <div data-testid="actions-bar-top" style={{display:'flex', alignItems:'center', justifyContent:'space-between', position:'sticky', top:64, zIndex:20, background:DS.color.bg, paddingTop:DS.spacing(4), paddingBottom:DS.spacing(4), borderBottom:`1px solid ${DS.color.bg}`}}>
