...
export default function Patterns() {
  ...
  return (
    <Container padY={12}>
      ...
      <div data-testid="actions-bar-top" style={{display:'flex', alignItems:'center', justifyContent:'space-between', height: 40, position: 'sticky', top: 0, zIndex: 20, background: DS.color.bg, paddingBottom: DS.spacing(2)}}>
